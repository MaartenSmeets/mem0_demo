...
## What This Does
- Chat with a local model via Ollama using the Responses API when available.
...
- `llm.py`: Responses API calls, structured output parsing, and memory-aware prompting.
